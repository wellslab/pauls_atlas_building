...
main_ensembl_ids = pd.read_csv('./ensembl_hg38.91_chromosome.csv').ensembl_gene_id.values.astype(str)
...
def convert_ensembl_to_symbols(dataframe):
    ...
    conversion = pd.read_csv('ensembl_hg38.91/gene_to_symbol_ensembl91_human.tsv', sep='\t', header=None, names=['ensembl', 'symbol'])
